...
public class ProcessingImage extends SuperClass1{
    ...
    public void OverwritePixel() {
        ...
        System.out.println("Processing took " + elapsedTime + " milliseconds"); //afisez timpul calculat
    ...
    private void varNumber() {
		// TODO Auto-generated method stub
		
	}

	private void varNumber(int i, int j, int k, int l) {
		// TODO Auto-generated method stub
		
	}

	private void varNumber(int i) {
		// TODO Auto-generated method stub
